...
public class LevelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sample = BitmapFactory.decodeResource(getResources(), R.drawable.monalisa_sample);
        ...
        barva.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(cisloBarvy[0]) {
                    case 0:
                        zmenBarvu("1", Color.rgb(231, 191, 103));
                        cisloBarvy[0]++;
                        Log.d("medard", "zmena barvy na 1");
                        break;
                    case 1:
                        zmenBarvu("2", Color.rgb(56, 36, 29));
                        cisloBarvy[0]++;
                        Log.d("medard", "zmena barvy na 2");
                        break;
                    case 2:
                        zmenBarvu("3", Color.rgb(155, 160, 104));
                        cisloBarvy[0]++;
                        Log.d("medard", "zmena barvy na 3");
                        break;
                    case 3:
                        zmenBarvu("4", Color.rgb(12,1,31));
                        cisloBarvy[0] = 0;
                        Log.d("medard", "zmena barvy na 3");
                        break;
                }
    ...
    private void hvezdicky(float sim) {
        ...
        if (sim < 50) {
            if (nactiVyslUzivatele("hvezdyLVL1") == 0) {
                new AlertDialog.Builder(LevelActivity.this)
                        ...
                        .setNegativeButton("zpět na výběr levelů", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Intent i = new Intent(LevelActivity.this, LevelsActivity.class);
                                startActivity(i);
            ...
            if (sim < 60) {
                ...
                hvezdy = 4;
                mess = "gratuluji! máš " +Math.round(sim) +"% shodu! Získáváš " +hvezdy + " hvězdičky";
                ulozPlaketkyUziv("plakLVL1", true);
            }


            if (nactiVyslUzivatele("hvezdyLVL1") == 0 || nactiVyslUzivatele("hvezdyLVL1") < hvezdy) {
                ...
                if (pref.getBoolean("plakLVL1", false)) {
                    new AlertDialog.Builder(LevelActivity.this)
                            ...
                            .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    Log.d("medard", "ziskana plaketka 1");
                                }
                            }).show();
                };
            } else {
