...
public class Level2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sample = BitmapFactory.decodeResource(getResources(), R.drawable.frida_sample);
        ...
        barva.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch(cisloBarvy[0]) {
                    case 0:
                        zmenBarvu("1", Color.rgb(182, 128, 69));
                        cisloBarvy[0]++;
                        Log.d("medard", "zmena barvy na 1");
                        break;
                    case 1:
                        zmenBarvu("2", Color.rgb(42, 36, 20));
                        cisloBarvy[0]++;
                        Log.d("medard", "zmena barvy na 2");
                        break;
                    case 2:
                        zmenBarvu("3", Color.rgb(207, 203, 200));
                        cisloBarvy[0]++;
                        Log.d("medard", "zmena barvy na 3");
                        break;
                    case 3:
                        zmenBarvu("4", Color.rgb(158,152,77));
                        cisloBarvy[0] = 0;
                        Log.d("medard", "zmena barvy na 3");
                        break;
                }
        ...
        navod.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(Level2Activity.this)
                        .setTitle("návod")
        ...
        if (sim < 40) {
            new AlertDialog.Builder(Level2Activity.this)
                    ...
                    .setPositiveButton("zopakovat level", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent i = new Intent(Level2Activity.this, Level2Activity.class);
                            startActivity(i);
                    ...
                    .setNegativeButton("zpět na výběr levelů", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Intent i = new Intent(Level2Activity.this, LevelsActivity.class);
                            startActivity(i);
            ...
            if (sim < 55) {
                ...
                hvezdy = 4;
                mess = "gratuluji! máš " + Math.round(sim) + "% shodu! Získáváš " + hvezdy + " hvězdičky";
                ulozPlaketkyUziv("plakLVL2", true);
            }

            if (nactiVyslUzivatele("hvezdyLVL2") == 0 || nactiVyslUzivatele("hvezdyLVL2") < hvezdy){
                    ...
                    new AlertDialog.Builder(Level2Activity.this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Log.d("medard", "ziskana plaketka 2");
                            }
                        }).show();
                };
            } else {
